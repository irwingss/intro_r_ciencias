...
```{r figura46, echo=FALSE, fig.cap='(ref:carga1)', fig.align='center', out.width="100%"}
knitr::include_graphics("figs/elaboradas/Extensiones.png")
```
...
```{r figura47, echo=FALSE, fig.cap='(ref:emergente1)', fig.align='center', out.width="100%"}
knitr::include_graphics("figs/screenshots/ventana emergente file choose.jpg")
```
