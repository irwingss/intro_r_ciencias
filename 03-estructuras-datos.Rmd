...
```{r figura42, echo=FALSE, fig.cap='(ref:estructuras2)', fig.align='center', out.width="100%"}
knitr::include_graphics("figs/elaboradas/Estructuras 2.png")
```
...
```{r figura43, echo=FALSE, fig.cap='(ref:gatocaja)', fig.align='center', out.width="100%"}
...
```{r figura44, echo=FALSE, fig.cap='(ref:strdatos1)', fig.align='center', out.width="100%"}
...
```{r figura45, echo=FALSE, fig.cap='(ref:factoresEjemplo)', fig.align='center', out.width="100%"}
data("iris")
